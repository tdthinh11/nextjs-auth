...
export default function LeftSide() {
  return (
    <div className="min-w-[280px] max-w-[360px] basis-360px">
      <div className="px-4 fixed mt-5 lg:block flex flex-col justify-between h-full">
        <div className="flex flex-col gap-2">
          <LeftSidebarLink image={Friend} text="Friends" path={PostList.friends}/>
          <LeftSidebarLink image={Group} text="Groups" path={PostList.groups}/>
          <LeftSidebarLink image={Market} text="Marketplace" path={PostList.marketPlace}/>
          <LeftSidebarLink image={Save} text="Saved" path={PostList.saved}/>
          <LeftSidebarLink image={Pages} text="Pages" path={PostList.pageRoute}/>
          <LeftSidebarLink image={Events} text="Events" path={PostList.events}/>
          <LeftSidebarLink image={MostRecent} text="Most Recent" path={PostList.mostRecent}/>
